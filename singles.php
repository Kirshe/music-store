...
<body>
  ...
  <a href="singles.php"><button class="btn" type="button" style="border-style:inset; background-color:white">Singles</button>
...
<?php
$res=mysqli_query($con,"select * from img_display where type like 'single'");
